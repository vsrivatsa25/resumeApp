    ...
    $.fn.extend({
        ...
        venobox: function(options) {
            ...
            var defaults = {
                ...
                spinner : 'folding-cube', // available: 'rotating-plane' | 'double-bounce' | 'wave' | 'wandering-cubes' | 'spinner-pulse' | 'chasing-dots' | 'three-bounce' | 'circle' | 'cube-grid' | 'fading-circle' | 'folding-cube'
                spinColor : '#d2d2d2',
